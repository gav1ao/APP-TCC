...
\newcommand{\entradaAutor}{GAVIÃO LIMA JANUARIO, V} % Sem ponto no final
% Titulo do trabalho
\titulo{Um aplicativo facilitador de compras} %Título do trabalho
\newcommand{\englishTitle}{A shopping facilitator app}
